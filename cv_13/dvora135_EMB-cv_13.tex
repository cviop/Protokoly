...
\textit{tohle je italikou} \textbf{tohle je tučně} \underline{tohle je podtrženo}

\section{blabla bla gkl}
\subsection{bdfbshgkjdgnr}
\subsubsection{ngjsngjrngjs,tng}
...
\begin{enumerate}
    ...
    \begin{enumerate}[label=\alph*)]
        \item  Zapojte převodník R → U s operačním zesilovačem podle schématu na obr. 1 (\var{U}{r} = 10 V, \var{R}{N1} = 10 k\tohm) a změřte závislost fp odporu snímače na jeho úhlové výchylce \var{\alpha} v rozsahu \var{\alpha}{} = 0 až 180° po 15° (klidové poloze snímače \var{\alpha} = 90° odpovídá hodnota odporu \var{R}{0}, tj. \var{\Delta}{}\var{R}{}~=~0).
